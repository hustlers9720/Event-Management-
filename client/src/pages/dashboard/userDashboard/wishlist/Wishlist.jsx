      ...
      <div className="grid gap-7">
        ...
        <div>
          ...
          <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
            <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
                <img src="https://files.prokerala.com/news/photos/imgs/1024/Delhi-Indiai-artists-perform-traditional-240418.jpg" alt="Art and Culture Festival" className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110" />
